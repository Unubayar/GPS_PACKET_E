...
namespace GPS
{
    public class GPS_Packet
    {
        ...
        //Packetheader
        public byte[] header { get; set; } = new byte[2];
        ...
        public byte[] unitCode { get; set; } = new byte[12];



        //Eventcode
        public byte[] eventCode { get; set; } = new byte[2];



        //Eventdata
        public byte[] eventData { get; set; } = new byte[2];



        //CRCSum from teachers code
        public ushort crcSum { get; set; }
